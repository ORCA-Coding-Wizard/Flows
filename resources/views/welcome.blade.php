...
<body class="bg-[#FDFDFC] min-h-screen flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center text-center px-6">
        <div>
            <h1 class="text-5xl font-bold text-[#1b1b18] mb-6">
            ...
            <a href="{{ route('register') }}"
                class="px-6 py-3 bg-[#f53003] text-white rounded-xl shadow-lg hover:bg-[#d42a02] transition">
                Mulai Sekarang
            </a>
        </div>
    </div>
    ...
    <!-- Footer -->
    <footer class="w-full bg-white text-center py-4 text-sm text-[#706f6c] border-t">
