<x-guest-layout>
    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-lg">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <x-text-input id="email" type="email" name="email"
                        ...
                        placeholder="Enter Email" :value="old('email')" required autofocus autocomplete="username" />

                    <svg class="absolute inset-y-0 right-3 my-3.5 h-5 w-5 text-[#B53543]"
            ...
            <div class="flex items-center justify-between mb-6">
                <label class="flex items-center text-sm text-gray-700 dark:text-gray-400">
                    <input id="remember_me" type="checkbox" name="remember"
                        class="w-4 h-4 text-[#B53543] rounded border-gray-300 focus:ring-[#B53543]" />
                    <span class="ml-2">Remember Me</span>
                </label>

                @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="text-sm text-[#000000] underline hover:text-[#B53543]">
                    Forgot Password?
                </a>
                @endif
            </div>
        ...
        <p class="text-center text-sm text-gray-700 dark:text-gray-400 mt-6">
            ...
            <a href="{{ route('register') }}" class="text-[#B53543] hover:underline">Sign Up</a>
        </p>
    </div>
</x-guest-layout>