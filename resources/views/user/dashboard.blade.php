    <x-app-layout>
        ...
        <section class="py-12">
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <form action="{{ route('user.papan.addSession') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="bg-gray-300 rounded overflow-hidden relative hover:scale-105 transition block w-full">
                        <div class="h-64 w-full">
        ...
        <footer class="bg-gray-900 text-white py-12 mt-16">
            <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="text-center md:text-left">
                    <div class="inline-flex items-center mb-3">
                        <svg viewBox="0 0 280 60" class="h-10">
                            <g transform="translate(20,28) scale(1.1)" fill="none" stroke="#fca5a5"
                                stroke-width="2">
                                <path d="M0-10c6-6 16-6 22 0-4 3-8 7-11 11-3-4-7-8-11-11z" />
            ...
            <div class="mt-8 text-center text-gray-500 text-sm">© {{ date('Y') }} Flows. All rights reserved.
            </div>
        </footer>
